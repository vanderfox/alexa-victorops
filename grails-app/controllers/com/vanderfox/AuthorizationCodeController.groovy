...
import com.vanderfox.AuthorizationCode
...
class AuthorizationCodeController {
    ...
    def save(AuthorizationCode authorizationCode) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'authorizationCode.label', default: 'AuthorizationCode'), authorizationCode.id])
    ...
    def update(AuthorizationCode authorizationCode) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'authorizationCode.label', default: 'AuthorizationCode'), authorizationCode.id])
                redirect authorizationCode
            }
    ...
    def delete(AuthorizationCode authorizationCode) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'authorizationCode.label', default: 'AuthorizationCode'), authorizationCode.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'authorizationCode.label', default: 'AuthorizationCode'), params.id])
                redirect action: "index", method: "GET"
            }
